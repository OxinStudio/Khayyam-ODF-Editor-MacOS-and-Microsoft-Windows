...
#define AppPublisher "Oxin Studio"
#define AppURL       "https://oxinstudio.com/khayyam-pdf-editor/"
...
AppSupportURL=https://oxinstudio.com/support
AppUpdatesURL={#AppURL}
AppCopyright=Copyright (C) 2026 Oxin Studio
